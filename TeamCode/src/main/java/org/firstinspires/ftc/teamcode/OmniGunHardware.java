...
public class OmniGunHardware {
    ...
    public DcMotor gunAxisMotor; //Rotation Control for Gun Barrel

    public DcMotor acceleratingMotor; //Motor Control for Projectile Acceleration
    ...
    public void init(LinearOpMode linearOpMode, HardwareMap ahwMap, Telemetry telemetry) {
        ...
        //Articulating Arm
        gunAxisMotor = hwMap.get(DcMotor.class, "gunAxisMotor");
        //Telescoping lift motor
        acceleratingMotor = hwMap.get(DcMotor.class, "acceleratingMotor");
        ...
        gunAxisMotor.setPower(0);
        acceleratingMotor.setPower(0);
    }
