...
@Autonomous(name="EncoderDepot", group="Autonomous")

public class EncoderDepot extends LinearOpMode {
...
*/
        ...
        robot.motor2.setTargetPosition(2);
        robot.motor4.setTargetPosition(-2);
        robot.timer.reset();
