...
@Autonomous(name="LowerAndGo", group="Autonomous")

public class LowerAndGo extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive() && (robot.timer.seconds() < 1.1)){
        ...
        double CLEARANCE = 1.2;
        robot.motor2.setPower(0.4); // go left 2 inches
        robot.motor4.setPower(-0.4);// assist left 2 inches
        robot.timer.reset();
        ...
        robot.motor2.setPower(-0.2); // go RIGHT 2 inches
        robot.motor4.setPower(0.2);// assist RIGHT 2 inches
        robot.timer.reset();

        while (opModeIsActive() && (robot.timer.seconds() < 1.6)){
            telemetry.addData("Clearance", "Left and Right: %2.5f S Elapsed", robot.timer.seconds());
            telemetry.update();
        }
        robot.motor2.setPower(0);
